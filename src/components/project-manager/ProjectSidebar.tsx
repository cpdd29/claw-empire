      ...
      <div className="border-b border-slate-700 px-4 py-3">
        ...
        <div className="mt-2 flex gap-2">
          ...
          <button
            ...
            className="rounded-md bg-slate-700 px-2.5 py-1 text-xs text-slate-200 hover:bg-slate-600"
          >
            {t({ ko: "GitHub 导入", en: "GitHub Import", ja: "GitHub インポート", zh: "GitHub 导入" })}
          </button>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {loadingList ? (
          <div className="px-4 py-6 text-xs text-slate-400">
            {t({ ko: "加载中...", en: "Loading...", ja: "読み込み中...", zh: "加载中..." })}
          </div>
        ) : projects.length === 0 ? (
          <div className="px-4 py-6 text-xs text-slate-500">
            {t({ ko: "暂无项目", en: "No projects", ja: "プロジェクトなし", zh: "暂无项目" })}
          </div>
        ) : (
