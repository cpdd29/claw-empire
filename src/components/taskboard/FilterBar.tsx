    ...
    <div className="flex flex-wrap items-center gap-2">
      <div className="relative min-w-[140px] flex-1 sm:min-w-[180px]">
        ...
        <input
          ...
          placeholder={t({ ko: "搜索任务...", en: "Search tasks...", ja: "タスク検索...", zh: "搜索任务..." })}
      ...
      >
        <option value="">{t({ ko: "全部门", en: "All Departments", ja: "全部署", zh: "全部门" })}</option>
      ...
      <AgentSelect
        ...
        placeholder={t({ ko: "全部代理", en: "All Agents", ja: "全エージェント", zh: "全部代理" })}
        size="md"
      />
      ...
      <select
        ...
        className="rounded-lg border border-slate-700 bg-slate-800 px-3 py-1.5 text-sm text-slate-300 outline-none transition focus:border-blue-500"
      >
        <option value="">{t({ ko: "全部类型", en: "All Types", ja: "全タイプ", zh: "全部类型" })}</option>
